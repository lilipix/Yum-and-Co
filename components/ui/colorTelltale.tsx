...
const colorTelltaleVariants = cva(
	'w-4 h-4',
	{
		variants: {
			variant: {
...
type ColorTelltaleProps = VariantProps<typeof colorTelltaleVariants> & LucideProps;

const ColorTelltale = ({ variant, className, ...props }: ColorTelltaleProps) => (
	<Diamond
