...
import { GeneralRecipeInformationFieldsSchema } from "@/app/(app)/recipes/components/form-fields/GeneralRecipeInformationFields";
import { IngredientsListFieldsSchema } from "@/app/(app)/recipes/components/form-fields/IngredientsListFields";
import { RecipeCategorySelectFieldSchema } from "@/app/(app)/recipes/components/form-fields/RecipeCategoriesSelectField";
import { RecipeTagsSelectFieldSchema } from "@/app/(app)/recipes/components/form-fields/RecipeTagsSelectField";
import { RecipePreparationFieldSchema } from "@/app/(app)/recipes/components/form-fields/RecipePreparationField";

const IngredientsListFields = dynamic(
  () =>
    import(
      "../../../../../recipes/components/form-fields/IngredientsListFields"
    ),
);
...
const GeneralRecipeInformationFields = dynamic(
  () =>
    import(
      "../../../../../recipes/components/form-fields/GeneralRecipeInformationFields"
    ),
);
...
const RecipePreparationForm = dynamic(
  () =>
    import(
      "../../../../../recipes/components/form-fields/RecipePreparationField"
    ),
);
