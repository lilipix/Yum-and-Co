...
const RecipeTagsSelectField = ({tags: initialTags, isDisabled = false, allowMultiple = true, enableColors = true, label = "Tags"}:RecipeCategoriesSelectFieldProps ) => {
    const form = useFormContext<RecipeTagsSelectFieldValues>();
    
    const {tags, isLoading, createTag: handleCreateTag, updateTag: handleUpdateTag } = useTagCreate(initialTags);
